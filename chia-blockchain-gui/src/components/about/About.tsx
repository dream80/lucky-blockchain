...
const url = 'https://www.lucksix.top';
    ...
    <html>
      ...
      <body>
        ...
        <StyledLink href={url}>
          ...
          <StyledTitle>
            {productName} 1.2.10.10
          </StyledTitle>
        </StyledLink>
        <StyledSubTitle>{description}</StyledSubTitle>
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Lucky Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/dream80/lucky-blockchain"
          target="_blank"
        >
          Report an issue
        </BugReport>
