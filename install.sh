...
echo ""
echo "Lucky blockchain install.sh complete."
echo "For assistance join us on Discord in the #support chat channel:"
echo "https://discord.com/invite/pgdj4snppb"
echo ""
echo "Try the Quick Start Guide to running lucky-blockchain:"
echo "https://github.com/dream80/lucky-blockchain"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'lucky init' to begin."
